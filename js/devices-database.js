...
const MedicalDevicesDatabase = {
  devices: [
    // ===== DIABETES-TECHNOLOGIEN =====
    {
      ...
      category: 'Diabetes',
      icon: 'ð',
      description: 'Kontinuierliche Glukose-Ãberwachung für Diabetes-Management',
    ...
    // ===== KARDIO =====
    {
      ...
      icon: 'â¤ï¸',
      description: 'Tragbare kontinuierliche Herzrhythmus-Ãberwachung',
