...
const ADHSTest = {
  ...
  questions: [
    ...
    { id: 5, category: 'Unaufmerksamkeit', subcategory: 'Unaufmerksamkeit', question: 'Ich werde leicht durch äu–ere Reize abgelenkt.' },
    ...
    { id: 10, category: 'Hyperaktivität', subcategory: 'Hyperaktivität', question: 'Ich zappele mit meinen Händen oder Fü–en.' },
  ...
  getInterpretation(score) {
    if (score <= 32) {
      ...
      return {
        ...
        text: 'Sie zeigen leicht bis mä–ig ausgeprägte ADHS-Symptome. Professionelle Evaluation wird empfohlen.'
      };
    } else if (score <= 96) {
      return {
        level: 'Moderat-Schwer',
        color: '#f97316',
        description: 'Mä–ig bis schwere Symptomausprägung',
