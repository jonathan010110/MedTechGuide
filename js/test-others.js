...
const AnxietyTest = {
  ...
  questions: [
    ...
    { id: 38, category: 'Kognitiv', question: 'Ich habe schwarzwei–ÂÂÂ-Denken beim Umgang mit Unsicherheit.' },
...
const BurnoutTest = {
  ...
  questions: [
    ...
    { id: 17, category: 'Leistung', question: 'Ich kann meine Arbeit nicht mehr so effizient bewältigen–ÂÂÂ' },
    ...
    { id: 38, category: 'Selbstpflege', question: 'Ich hab Zeit für Hobbys und zeitgemä–ÂÂÂe Aktivitäten gegeben.' },
...
const StressTest = {
  ...
  questions: [
    ...
    { id: 1, category: 'Kontrolle', question: 'Ich fühle mich überfordert von Ereignissen au–ÂÂÂerhalb meiner Kontrolle.' },
    ...
    { id: 6, category: 'Veränderungen', question: 'Ich erlebe gro–ÂÂÂe Veränderungen in meinem Leben.' },
    { id: 7, category: 'Veränderungen', question: 'Meine Lebensumstände haben sich erheblich verändert.' },
    { id: 8, category: 'Veränderungen', question: 'Ich habe schwierige persönliche –ÂÂÂbergänge erlebt.' },
  ...
  getInterpretation(score) {
    if (score <= 15) {
      ...
      return {
        ...
        color: '#f59e0b',
        description: 'Leicht bis mä–ÂÂÂige Stressbelastung',
        text: 'Sie zeigen leichte bis mä–ÂÂÂige Stressbelastung. Achtsamkeit und Entspannungstechniken werden empfohlen.'
      };
    } else if (score <= 50) {
      return {
        level: 'Moderat-Schwer',
        color: '#f97316',
        description: 'Mä–ÂÂÂig bis schwere Stressbelastung',
        text: 'Sie zeigen mä–ÂÂÂig bis schwere Stressbelastung. Professionelle Unterstützung wird empfohlen.'
      };
    } else {
      return {
        level: 'Schwer',
...
const SleepQualityTest = {
  ...
  questions: [
    ...
    // FR–ÂÂÂHMORGLICHES ERWACHEN (5 Fragen)
    ...
    { id: 36, category: 'Muster', question: 'Meine Schlafens- und Aufwachzeiten sind unregelmä–ÂÂÂig.' },
    { id: 37, category: 'Muster', question: 'Ich arbeite in Schichten oder habe unregelmä–ÂÂÂige Arbeitszeiten.' },
