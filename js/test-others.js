...
const AnxietyTest = {
  ...
  questions: [
    ...
    { id: 38, category: 'Kognitiv', question: 'Ich habe schwarzwei–-Denken beim Umgang mit Unsicherheit.' },
...
const BurnoutTest = {
  ...
  questions: [
    ...
    { id: 17, category: 'Leistung', question: 'Ich kann meine Arbeit nicht mehr so effizient bewältigen–' },
    ...
    { id: 38, category: 'Selbstpflege', question: 'Ich hab Zeit für Hobbys und zeitgemä–e Aktivitäten gegeben.' },
...
const StressTest = {
  ...
  questions: [
    ...
    { id: 1, category: 'Kontrolle', question: 'Ich fühle mich überfordert von Ereignissen au–erhalb meiner Kontrolle.' },
    ...
    { id: 6, category: 'Veränderungen', question: 'Ich erlebe gro–e Veränderungen in meinem Leben.' },
    { id: 7, category: 'Veränderungen', question: 'Meine Lebensumstände haben sich erheblich verändert.' },
    { id: 8, category: 'Veränderungen', question: 'Ich habe schwierige persönliche –bergänge erlebt.' },
  ...
  getInterpretation(score) {
    if (score <= 15) {
      ...
      return {
        ...
        color: '#f59e0b',
        description: 'Leicht bis mä–ige Stressbelastung',
        text: 'Sie zeigen leichte bis mä–ige Stressbelastung. Achtsamkeit und Entspannungstechniken werden empfohlen.'
      };
    } else if (score <= 50) {
      return {
        level: 'Moderat-Schwer',
        color: '#f97316',
        description: 'Mä–ig bis schwere Stressbelastung',
        text: 'Sie zeigen mä–ig bis schwere Stressbelastung. Professionelle Unterstützung wird empfohlen.'
      };
    } else {
      return {
        level: 'Schwer',
...
const SleepQualityTest = {
  ...
  questions: [
    ...
    // FR–HMORGLICHES ERWACHEN (5 Fragen)
    ...
    { id: 36, category: 'Muster', question: 'Meine Schlafens- und Aufwachzeiten sind unregelmä–ig.' },
    { id: 37, category: 'Muster', question: 'Ich arbeite in Schichten oder habe unregelmä–ige Arbeitszeiten.' },
