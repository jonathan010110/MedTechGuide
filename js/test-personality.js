...
const PersonalityTest = {
  ...
  questions: [
    ...
    { id: 1, dimension: 'EI', polarity: 'E', question: 'Ich genie–e Gro–veranstaltungen und bin gerne unter vielen Menschen.' },
    ...
    { id: 12, dimension: 'SN', polarity: 'N', question: 'Ich sehe gerne grö–ere Muster und Zusammenhänge.' },
    ...
    { id: 33, dimension: 'JP', polarity: 'J', question: 'Ich möchte Dinge erledigt haben und abschlie–en.' },
  ...
  types: {
    ENTJ: {
      ...
      challenges: 'â –¯¸ Ungeduldig, Direkt, Fokus nur auf Effizienz',
    ...
    INTJ: {
      ...
      strength: '–°–¯¸ Visionar, Unabhängig, Planungsorientiert, Intellektuello',
      challenges: 'â –¯¸ Zu kritisch, Unflexibel, Kann emotionale Nuancen übersehen',
    ...
    ENTP: {
      ...
      challenges: 'â –¯¸ Verliert Fokus, Ungeduldig, Kann andere reizen mit Debaten',
    ...
    INTP: {
      ...
      challenges: 'â –¯¸ Kann sozial unbeholfen sein, Perfektionist, Prokrastiniert',
    ...
    ESFJ: {
      ...
      challenges: 'â –¯¸ Kann zu geschwätzig sein, Braucht viel Bestätigung, Unhaft neuer Ideen',
    ...
    ISFJ: {
      ...
      strength: '–°¡–¯¸ Zuverlässig, Geduldig, Unterstützender, Praktischer',
      challenges: 'â –¯¸ Zu zurückhaltend, Kann Ärger anstauen, Schwer mit Kritik',
    ...
    ESFP: {
      ...
      challenges: 'â –¯¸ Kann oberflächlich sein, Schwierigkeiten mit langen Frist-Aufgaben',
    ...
    ISFP: {
      ...
      challenges: 'â –¯¸ Kann sich zu emotional in Dinge verfangen, Schwierigkeiten mit Hierachien',
      workplace: 'Kunst, Design, Handwerk, Coaching, Adventure Tourism',
      description: 'ISFPs sind sensible und künstlerische Geister. Sie leben nach ihren Werten und genie–en die Vielfalt.'
    },
    ESTJ: {
      name: 'Der Logistiker (ESTJ)',
      strength: '–° Organisiert, Verantwortungsvoll, Treuer, Hardworker',
      challenges: 'â –¯¸ Kann zu rigid sein, Schwierigkeiten mit unkonventionellen Ideen',
    ...
    ISTJ: {
      ...
      strength: 'â–¯¸ Verantwortungsvoll, Praktisch, Loyal, Gründlic',
      challenges: 'â –¯¸ Kann zu steif sein, Schwierigkeiten mit Veränderungen',
    ...
    ESTP: {
      ...
      challenges: 'â –¯¸ Kann rücksichtslos sein, Schwierigkeiten mit Planung',
    ...
    ISTP: {
      ...
      challenges: 'â –¯¸ Kann unflexibel sein, Schwierigkeiten mit emotionaler Kommunikation',
    ...
    ENFJ: {
      ...
      challenges: 'â –¯¸ Kann zu idealistisch sein, Braucht viel soziale Validierung',
    ...
    INFJ: {
      ...
      strength: '–°Â® Einfühlsam, Idealistisch, Intuitiv, Tiefgründig',
      challenges: 'â –¯¸ Kann zu perfektionistisch sein, –berfordert durch zu viele Anfragen',
      workplace: 'Beratung, Psychologie, Schreiben, Künstlerisches',
      description: 'INFJs sind tiefe und idealistical Denker. Sie sehen gro–es Potenzial bei anderen und wollen helfen.'
    },
    ENFP: {
      name: 'Der Kampagner (ENFP)',
      strength: '–° Charismatisch, Spontan, Kreativ, Enthusiastisch',
      challenges: 'â –¯¸ Kann unstet sein, Schwierigkeiten mit Fokus',
    ...
    INFP: {
      ...
      challenges: 'â –¯¸ Kann verletzlich sein, Schwierigkeiten mit Konflikten',
